...
@section('clearanceContent')
    ...
    <div class="column" style="padding-top: 50px;">
        <span class="dropspanCurrent"  >Distance Student</span></br>
        <hr size="3" width="100%" color="gray">
        <a href="/clearance/distance student" class="requestA" style="border-radius: 4px;">Request Form</a>
        <a href="/clearance/distance student/form" class="submitA">Clearance Submit Form</a>
        <hr size="3" width="100%" color="gray">
    </div>  
