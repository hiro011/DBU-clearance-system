                    ...
                    <form action="{{ route('clearanceUsers.checkTeacher') }}" method="POST">
                        ...
                        <div class="accordion department">
                            ...
                            <label for="section1" class="accordion__label">
                                ...
                                <img src="/img/caret-down-outline.svg" alt="down-icon" class="acc-down-icon">
                                <span style="margin-left: 3px;">{{ $teacher['department'] }} department</span>
                            </label>
                        ...
                        <div class="accordion collFinance">
                            ...
                            <label for="section7" class="accordion__label">
                                ...
                                <img src="/img/caret-down-outline.svg" alt="down-icon" class="acc-down-icon">
                                <span style="margin-left: 3px;">Enginnering College Finance</span>
                            </label>
                            ...
                            <div class="accordion__content">
                                @if($CollFinance)
                                    ...
                                    @if(($CollFinance->balance) > 0)
                                        <p style="color: red;"> Declined </p>
                                        <p>
                                            Your balance in Enginnering College Finance is " {{ $Finance['balance'] }} "
                                            You didnt get the approval of the Enginnering College Finance office, 
                                            that means you have dept to pay, you have to pay your dept before requesting clearance,
                                            if there is any problem you can go check in the Enginnering College Finance office,
                                        </p>
                                    @endif
                                    @if(($CollFinance->balance) > 0)
                                        <p style="color: orangeS;"> Declined </p>
                                        <p>
                                            Your balance in Enginnering College Finance is " {{ $CollFinance['balance'] }} "
                                            that means you have some moeny to collect, 
                                            if there is any problem you can go check in the Enginnering College Finance office,
                                        </p>
                                    @endif
                        ...
                        <div class="accordion Research">
                            ...
                            <label for="section9" class="accordion__label">
                                @if($Research)
                                    @if(($Research->status) === 'Finished')
                                    <img src="/img/success-icon.png" alt="success-icon" class="success">
                                    @endif
                                ...
                                <img src="/img/caret-down-outline.svg" alt="down-icon" class="acc-down-icon">
                                <span style="margin-left: 3px;">Research Office</span>
                            </label>
                            ...
                            <div class="accordion__content">
                                @if($Research)
                                    ...
                                    @if(($Research->status) !== 'Finished')
                                        <p style="color: red;"> Declined </p>
                                        <p>
                                            You didnt get the approval of the Research office, 
                                            that means you didnt finish your research, 
                                            you have to finish your research or report back before requesting clearance,
                                            if there is any problem you can go check in the Research office,
                                        </p>
                                    @endif
                                @endif
                                @if(!$Research)
                        ...
                        <div class="accordion GenService">
                            ...
                            <label for="section8" class="accordion__label">
                                ...
                                <img src="/img/caret-down-outline.svg" alt="down-icon" class="acc-down-icon">
                                <span style="margin-left: 3px;">General Service Office</span>
                            </label>
                            ...
                            <div class="accordion__content">
                                @if($GenService)
                                    ...
                                    @if(($GenService->status) === 'stay')
                                        <p style="color: red;"> Declined </p>
                                        <p>
                                            You didnt get the approval of the General Service office, 
                                            that means you didnt submit your apartment materials back, 
                                            you have to submit your apartment materials back before requesting clearance,
                                            if there is any problem you can go check in the General Service office,
                                        </p>
                                    @endif
                                @endif
                                @if(!$GenService)
                        ...
                        <div class="accordion AntiCorrupt">
                            <input type="checkbox" name="example_accordion" id="sectiona" class="accordion__input">
                            <label for="sectiona" class="accordion__label">
                                @if($AntiCorrupt)
                                    @if(($AntiCorrupt->status) !== 'working')
                                    <img src="/img/success-icon.png" alt="success-icon" class="success">
                                    @endif
