    ...
    <section id="columns">
        <div class="body-container">
            <div class="column" style="padding-top: 50px;">
                ...
                <a href="/clearance/regular student" class="requestA" style="border-radius: 4px;">Request Form</a>
                <a href="/clearance/regular student/form" class="submitA" style="border-radius: 4px;">Clearance Submit Form</a>
                <hr size="3" width="100%" color="gray">
        ...
        <div class="accordion">
            ...
            <div class="container-1">
                ...
                <label for="section1" class="accordion__label">
                    ...
                    <span style="margin-left: 5px;">  LoggedUser['department'] department</span>
                </label>
                <div class="accordion__content">
                    <div class="passRemark">
                    ...
                    <div class="failRemar">
                        ...
                        <p>
                            ...
                            you can check the problem by going to your department office
                        </p>
                    </div>
                </div>
            </div>
